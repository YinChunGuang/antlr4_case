...
public class VecParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "Vec.g4"; }
	...
	public static class Vec4Context extends ParserRuleContext {
		...
		public Vec4Context(ParserRuleContext parent, int invokingState) { super(parent, invokingState); }
		public Vec4Context(ParserRuleContext parent, int invokingState, int max) {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof VecListener ) ((VecListener)listener).enterVec4(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof VecListener ) ((VecListener)listener).exitVec4(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof VecVisitor ) return ((VecVisitor<? extends T>)visitor).visitVec4(this);
			else return visitor.visitChildren(this);
		}
	}

	public final Vec4Context vec4(int max) throws RecognitionException {
		Vec4Context _localctx = new Vec4Context(_ctx, getState(), max);
	...
	public static class IntsContext extends ParserRuleContext {
		public int max;
		public int i = 1;
		public List<TerminalNode> INT() { return getTokens(VecParser.INT); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof VecListener ) ((VecListener)listener).enterInts(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof VecListener ) ((VecListener)listener).exitInts(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof VecVisitor ) return ((VecVisitor<? extends T>)visitor).visitInts(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\3\2\2\4\2\4\2\2\2\23\2\6\3\2\2\2\4\n\3\2\2\2\6\7\7\3\2\2\7\b\5\4\3\2"+
		"\b\t\7\4\2\2\t\3\3\2\2\2\n\21\7\6\2\2\13\f\7\5\2\2\f\r\b\3\1\2\r\16\6"+
		"\3\2\3\16\20\7\6\2\2\17\13\3\2\2\2\20\23\3\2\2\2\21\17\3\2\2\2\21\22\3"+
		"\2\2\2\22\5\3\2\2\2\23\21\3\2\2\2\3\21";
